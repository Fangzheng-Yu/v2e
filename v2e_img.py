...
def main():
    ...
    args.input = "./data/test_images"
    args.output_folder = os.path.join("./output",os.path.split(args.input)[-1])
    args.input_frame_rate = 1000
    args.disable_slomo = True
    args.start_time =None
    args.stop_time = None
    print(args.output_folder)
    args.dvs_h5 = None
    args.dvs_text = "dvs.txt"
    args.dvs_img = True
    args.dvs_exposure[0] ='source'
...
#         v2e_quit(1)
   ...
   # input file checking
    ...
    emulator = EventEmulator(
        ...
        dvs_text=dvs_text,dvs_img =args.dvs_img, show_dvs_model_state=args.show_dvs_model_state,
